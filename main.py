...
# for _ in range(0, LIST_SIZE):
#     l1.append(random.randint(0, RANDOM_UPPER_BOUND))
#     l2.append(random.randint(0, RANDOM_UPPER_BOUND))
#
# l1.sort()
# l2.sort()
#
...
# print(f"Список1: {l1}")
# print(f"Список2: {l2}")
# print(f"Список со значениями которые не пересекаются в списках 1 и 2: {l3}")
...
#
# print(f"Обьеденённый словарь: {dict4}")
